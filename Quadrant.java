...
public class Quadrant
{
    public static void main( String[] args) {
        ...
        System.out.println("Enter a Coordinate");  //prompt the user for an x-coordinate
        x= keys.nextDouble();
        System.out.println("Enter a second coordinant");  //prompt the user for a y-coordinate
        y = keys.nextDouble();
        keys.close();
        ...
        if (x > 0 && y > 0) {
            ...
            System.out.println( "Your point is at the origin");
        }
